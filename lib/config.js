...
Router.route('/video_chat/:callerId/calling/:pickerId/:chat_room_id', function () {
...
Router.route('/video_chat/accept_call/:video_chat_roomId', function () {
  var video_session_id = this.params.video_chat_roomId; // "5"
